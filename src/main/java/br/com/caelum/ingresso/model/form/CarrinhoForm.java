...
//classe que representa o formulario, que transformara um ingresso incompleto (só com ids dos objetos) transformando em objeto
public class CarrinhoForm {
	...
	//Retorna uma lista de ingressos validos, ou seja, os objetos inteiros não apenas OS id's
